    ...
    else while (getopt)
    {
        ...
        else if (getopt.match("-?", "-h", "--help"))
        {
            ...
            log("\nText-based Desktop Environment " + text{ app::shared::version } +
                "\n(virtual terminal multiplexer - desktop mode)"
                "\n"
                ...
                #endif
                "\n"
                "\n    <script relay via piped redirection> | vtm-desk [ -p <id> ]"
                "\n"
                "\n  Options:"
                "\n"
                "\n    Without options, vtm-desk runs Desktop Server and Desktop Client."
                "\n"
                ...
                "\n                         Run 'sudo vtm-desk --mouse 0' to reset access."
                #endif
                ...
                "\n"
                "\n      'vtm-desk -r vtty <cui_app...>' can be shortened to 'vtm-desk <cui_app...>'."
                "\n      'vtm-desk -r dtty ssh <user@host dtvt_app...>' can be shortened to 'vtm-desk ssh <user@host dtvt_app...>'."
                "\n"
                ...
                "\n"
                "\n      vtm-desk -c \"<config><terminal><scrollback size=1000000/></terminal></config>\" -r term"
                "\n      or (using compact syntax)"
                "\n      vtm-desk -c \"<config/terminal/scrollback size=1000000/>\" -r term"
                "\n");
            return 0;
        }
